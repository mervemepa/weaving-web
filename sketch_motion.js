...
var s = function (m) {
  ...
  m.setup = function () {
    ...
    canvas_motion.parent("sketchMotion");
    ...
    myInp2.position(10, height - 32);
    myInp2.size(width - 33);
  ...
  m.draw = function () {
    ...
    // noLoop();
    if (m.millis() - currentTime > shiftDeltaTime) {
      currentTime = m.millis();
      m.clearAllThreads();
      shiftThreadVal2++;
...
var myp5 = new p5(s, "sketchMotion");
